...
Date.parseLocale = function Date$parseLocale(value, formats) {
    /// <summary locid="M:J#Dates.parseLocale" />
    /// <param name="value" type="String"></param>
    /// <param name="formats" parameterArray="true" optional="true" mayBeNull="true"></param>
    /// <returns type="Dates"></returns>
    var e = Function._validateParams(arguments, [
        {name: "value", type: String},
...
Date.parseInvariant = function Date$parseInvariant(value, formats) {
    /// <summary locid="M:J#Dates.parseInvariant" />
    /// <param name="value" type="String"></param>
    /// <param name="formats" parameterArray="true" optional="true" mayBeNull="true"></param>
    /// <returns type="Dates"></returns>
    var e = Function._validateParams(arguments, [
...
Date.prototype.format = function Date$format(format) {
    /// <summary locid="M:J#Dates.format" />
    /// <param name="format" type="String"></param>
    /// <returns type="String"></returns>
    var e = Function._validateParams(arguments, [
        {name: "format", type: String}
...
Date.prototype.localeFormat = function Date$localeFormat(format) {
    /// <summary locid="M:J#Dates.localeFormat" />
    /// <param name="format" type="String"></param>
    /// <returns type="String"></returns>
    var e = Function._validateParams(arguments, [
        {name: "format", type: String}
...
Sys.Serialization.JavaScriptSerializer._dateRegEx = new RegExp('(^|[^\\\\])\\"\\\\/Dates\\((-?[0-9]+)(?:[a-zA-Z]|(?:\\+|-)[0-9]{4})?\\)\\\\/\\"', 'g');
...
Sys.Serialization.JavaScriptSerializer.deserialize = function Sys$Serialization$JavaScriptSerializer$deserialize(data, secure) {
    ...
    try {    
        var exp = data.replace(Sys.Serialization.JavaScriptSerializer._dateRegEx, "$1new Dates($2)");
